...
const springConstant = 0.6; // Slightly stronger spring
const damping = 0.1; // Base damping
...
canvas.addEventListener('mousemove', function(e) {
    ...
    if (isDraggingHandle) {
        ...
        ropePoints[numSegments - 1].y = mouseY;
    }
});
...
function animate() {
    ...
    // Show/hide login and message based on pull-down distance
    const pullDistance = ropePoints[numSegments - 1].y - 20 - ((numSegments - 1) * segmentLength);
